...
% Song Metadata
%
% When creating music and words for use with AcapellaWorship lilypond templates
% be sure to supply values for all of these fields.  If data isn't available for
% a particular field, set the field to false (##f).
%
title = #"Hark! I Hear the Harps Eternal"
songNumber = "A-001"
scripture = #"And I heard a voice from heaven, like the sound of many waters
  and like the sound of loud thunder, and the voice which I heard
  was like the sound of harpists playing on their harps. (Rev. 14:2)"
...
maintainer = "Jim Duke"
maintainerEmail = "James.Enoch.Duke@gmail.com"
maintainerWeb = "www.acapellaworship.org"

copyright = \markup { "Arrangement" \char ##x00A9 "2015 Michael Duke" }
license = \markup {
  \general-align #Y #CENTER {
    \epsfile #X #10 #"cc_small_button_by.eps"
